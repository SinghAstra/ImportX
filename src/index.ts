...
// Semantic Tracking Core Registry: Holds resolved semantic names and descriptions generated by Gemini
...
/**
 * Token-Efficient AI Metadata Labeling Layer
 * Packages structural maps and passes context payloads to the Gemini API.
 */
