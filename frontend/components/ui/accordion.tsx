...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon className="text-muted-foreground pointer-events-none size-8 shrink-0 translate-y-0.5 transition-transform duration-300 bg-muted/40 border rounded" />
      </AccordionPrimitive.Trigger>
